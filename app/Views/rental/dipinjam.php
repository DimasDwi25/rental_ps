        ...
        <tbody>
          <?php if (!empty($rentals)): ?>
            ...
            <tr>
              ...
              <td>
                <a href="<?= base_url('/rental/update-status/' . $rental['id'] . '/selesai') ?>" class="btn btn-success" onclick="return confirm('Apakah Anda yakin ingin menyelesaikan peminjaman ini?');">Selesai</a>
              </td>
              <td>

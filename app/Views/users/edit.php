<section class="section">
  <div class="row">
    ...
    <div class="col-md-12">
        <form class="card" action="<?= site_url('users/update/' . esc($users['id'])) ?>" method="POST" enctype="multipart/form-data">
            <?= csrf_field(); ?>
                ...
                <div class="row row-cards">
                    <div class="mb-3">
                        ...
                        <input type="text" id="username" name="username"
                            ...
                            placeholder="Enter username..." value="<?= $users['username'] ?>" required>
